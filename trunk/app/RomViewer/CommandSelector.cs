    ...
    public partial class CommandSelector : Form
    {
        ...
        private void LoadCommands()
        {
            ...
            else
            {
                ...
                _commandList.Commands.Add(new GameCommand("Quest: Hand in Dogs quest", "for i=0,9,1 do player:target_NPC(\"Robbie Butcher\"); sendMacro(\"OnClick_QuestListButton(1,1)\"); yrest(100); sendMacro(\"AcceptQuest()\"); yrest(100); player:target_NPC(\"Robbie Butcher\"); sendMacro(\"OnClick_QuestListButton(3,1)\"); sendMacro(\"CompleteQuest()\"); yrest(100); end;", true));
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (bsCommands.Current != null)
            {
                ...
                if (cmd.AutoRun)
                {
                    mmServer.ServerInstance.QueueCommand(cmd.CommandText);
                }
                else
                {
