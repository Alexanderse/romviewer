...
namespace EMK.Cartography
{
	...
	public class Node
	{
		...
		public Node(double PositionX, double PositionY, double PositionZ, object data)
		{
		...
		public bool Passable
		{
			set
			{
				foreach (Arc A in _IncomingArcs) A.IsPassable = value;
				foreach (Arc A in _OutgoingArcs) A.IsPassable = value;
				_Passable = value;
			}
		...
		public override string ToString() { return GetText() + ": " + Position.ToString(); }
